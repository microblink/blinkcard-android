 ...
 */
fun preloadScanBeep(context: Context, @RawRes soundResId: Int = R.raw.mb_blinkcard_beep) {
 ...
 */
fun playScanBeep(context: Context, @RawRes soundResId: Int = R.raw.mb_blinkcard_beep) {
    synchronized(ScanSoundPlayerState) {
        if (ScanSoundPlayerState.soundPool == null || ScanSoundPlayerState.loadedResId != soundResId) {
